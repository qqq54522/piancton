...
更新时间：2026-09-16
当前范围：Phase 0～Phase 6；D349～D367 AI Search 单入口、自由问答 Agent、渠道目录、账号引导头像与业务端每日反馈
当前状态：D367 业务端每日昨日反馈已在本地完成并通过完整回归，云端未部署；D366 新人引导与私有账号头像已经部署到云端；D365～D349 的当前事实与上线状态以总纲接力区为准。
